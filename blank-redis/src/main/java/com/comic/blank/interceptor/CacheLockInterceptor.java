package com.comic.blank.interceptor;

import com.comic.blank.annotation.CacheLock;
import com.comic.blank.annotation.LockedComplexObject;
import com.comic.blank.annotation.LockedObject;
import com.comic.blank.exception.CacheLockException;
import com.comic.blank.util.RedisLock;
...
/**
 * 通过拦截器，在invoke方法中获取注解的方法和参数，在执行注解的方法前加锁，执行被注解的方法后释放锁
 *
 * @author wangchen
 * createAt 2019/5/28
 * updateAt 2019/5/28
